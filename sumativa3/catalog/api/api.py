...
@api.get("/providers", response={200: List[ProviderSchema]}, summary="List of providers")
...
@api.get("/contact", response={200: List[ContactSchema]}, summary="List of contacts")
...
@api.get("/addresses", response={200: List[AddressSchema]}, summary="List of addresses")
...
@api.get("/services", response={200: List[ServiceSchema]}, summary="List of services")
